        // ==UserScript==
        // @name         LaborSummary Totals V1.0
        // @namespace    http://tampermonkey.net/
        // @version      1.0 3/17/2022
        ...
        function createTimeBlockArray(numHoursPer){
            ...
            endDateTimeValue.setMinutes(endDateTimeValue.getMinutes());
        ...
        function insertControls(){
            ...
            document.getElementsByTagName(nextElementAfterDisplayTagKey)[0].insertAdjacentHTML(displayInsertKey,  createDropDownFromArray(hourSegmentDropDownID, tArray, tArray) );
